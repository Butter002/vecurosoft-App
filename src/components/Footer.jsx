  ...
  return (
    <footer className="bg-[#062f33] text-white overflow-hidden relative">
      ...
      <div className="md:grid grid-cols-1 flex flex-col  gap-10 md:grid-cols-2 lg:grid-cols-3  px-6 xl:px-40 py-16">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-6">
            ...
            <div className="flex items-center gap-3">
              <div className="bg-[#0c4348] hover:bg-green-700 p-3 rounded-full">
                <FaFacebookF className="text-white text-lg"/>
              </div>
              <div className="bg-[#0c4348] p-3 hover:bg-green-700 rounded-full">
        ...
        <div className="h-[2px] w-full  bg-[#144f56] flex justify-start  mb-6"><div className=" h-full w-10 bg-green-600"></div></div>
