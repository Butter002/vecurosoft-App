...
function Service() {
    ...
    <>
      <Header />
      {/* Banner */}
      <div className="relative w-full h-[400px] bg-cover flex justify-cente pl-50 bg-center" style={{ backgroundImage: `url(${ServiceBannner})` }}>
        <img src={map} alt="" className="absolute top-20 left-5" />
        <div className="flex flex-col pl-10 justify-center gap-2 items-start h-full">
          <p className="text-white font-bold text-7xl">our <span className="text-green-500">service</span></p>
          <div className="flex flex-row justify-start">
            <a href="/" className="text-white text-xl font-extrabold">Home</a>
      ...
      {/* forth section  */}
        {/* section 3 */}
          <div className="bg-green-300/10 py-12 lg:m-1 px-4 md:px-16 xl:px-40">
