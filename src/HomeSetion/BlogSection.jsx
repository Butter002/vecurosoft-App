    ...
    const Blog = () => {
    return (
        <div className="py-22 bg-gradient-to-b from-white to-green-400/10">
        <div className="container mx-auto px-4">
            ...
            {/* Large Blog Card */}
            <div className="bg-white rounded-3xl p-5  shadow-lg overflow-hidden flex flex-col group">
                <div className="relative w-7/7 h-1/2 rounded-2xl overflow-hidden">
            ...
            <div className="flex flex-col  gap-8">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[rgba(16,156,61,0.3)] to-[rgba(255,255,255,0)] pointer-events-none z-10"></div>
                    ...
                    <span className="read-line w-25 h-0.5 bg-green-600/70 block"></span>
                    </div>
